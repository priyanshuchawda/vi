...
import { ALL_SUPPORTED_MIME_TYPES, getMediaType, formatFileSize, MAX_FILE_API_SIZE } from '../../types/chat';
...
const ChatInput = ({ onSendMessage, disabled }: ChatInputProps) => {
  ...
  const getTypeColor = (type: MediaAttachment['type']) => {
    switch (type) {
      ...
      case 'audio': return 'text-amber-400 bg-amber-400/10 border-amber-400/20';
