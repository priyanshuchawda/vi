          ...
          {stats.totalTokens > 0 && (
            <div className="pt-1 border-t border-gray-700 space-y-1">
              ...
              <div className="flex justify-between">
                ...
                <span className={`font-mono ${getContextColor()}`}>
              ...
              <div className="flex justify-between">
                ...
                <span className="text-white font-mono">
                  ${budget.perTurnSoftUsd.toFixed(4)} / ${budget.perTurnHardUsd.toFixed(4)}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Session cap:</span>
                <span className="text-white font-mono">
                  ${budget.perSessionSoftUsd.toFixed(4)} / ${budget.perSessionHardUsd.toFixed(4)}
                </span>
              </div>
              {/* Context window bar */}
