...
import { YouTubeCredentialModal } from '../ui/YouTubeCredentialModal';
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <div>
                <label
                  htmlFor="youtube-upload-title"
                  className="block text-xs font-medium text-text-muted mb-1"
                >
                  Title *
                </label>
                <input
                  id="youtube-upload-title"
                  type="text"
                  value={title}
              ...
              <div>
                <label
                  htmlFor="youtube-upload-description"
                  className="block text-xs font-medium text-text-muted mb-1"
                >
                  Description
                </label>
              ...
              <div>
                <label
                  htmlFor="youtube-upload-tags"
                  className="block text-xs font-medium text-text-muted mb-1"
                >
                  Tags (comma separated)
                </label>
                <input
                  id="youtube-upload-tags"
                  type="text"
                  value={tags}
              ...
              <div>
                <label
                  htmlFor="youtube-upload-privacy"
                  className="block text-xs font-medium text-text-muted mb-1"
                >
                  Privacy
                </label>
                <select
                  id="youtube-upload-privacy"
                  value={privacyStatus}
                  onChange={(e) =>
              ...
              <div className="flex items-center gap-2">
                <input
                  type="checkbox"
                  id="youtube-upload-made-for-kids"
                  checked={madeForKids}
                  onChange={(e) => setMadeForKids(e.target.checked)}
                  className="w-4 h-4 accent-accent"
                />
                <label
                  htmlFor="youtube-upload-made-for-kids"
