...
const Timeline = () => {
  ...
  const trackGroups = clips.reduce(
    (acc, clip) => {
  ...
  const trackIndices = Object.keys(trackGroups)
    .map(Number)
    .sort((a, b) => a - b);
    ...
    const handleMouseMove = (moveEvent: MouseEvent) => {
      ...
      if (type === 'start') {
        ...
        const newEnd = Math.max(
          clip.start + 0.1,
          Math.min(clip.sourceDuration, initialValue + deltaTime),
        );
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1.5 bg-bg-surface px-2 py-1 rounded">
              ...
              />
              <span className="text-[10px] text-text-muted font-mono w-7 text-right">
                {pixelsPerSecond}px
              </span>
            </div>
                            ...
                            <button
                              ...
                              className={clsx(
                                ...
                                clip.muted
                                  ...
                                  : 'bg-bg-primary/80 text-text-primary hover:bg-bg-primary',
                              )}
        ...
        >
          ...
          >
            ...
            <div className="flex gap-2">
              ...
              <button
                className="flex-1 py-1 rounded bg-gray-700 hover:bg-gray-600 text-white text-sm"
                onClick={() => setSpeedInput(null)}
              >
                Cancel
              </button>
