        ...
        {!activeClip ? (
          ...
          <>
            ...
            <div className="mb-5">
              ...
              <Slider label="Speed" value={displaySpeed} min={0.25} max={4} step={0.25}
                onChange={handleSpeedChange} displayValue={`${displaySpeed}x`} />
            </div>
            ...
            <div className="mb-5">
              ...
              <Slider label="Brightness" value={brightness} min={-1} max={1} step={0.05} onChange={v => handleEffectChange('brightness', v)} />
              <Slider label="Contrast" value={contrast} min={0} max={3} step={0.1} onChange={v => handleEffectChange('contrast', v)} />
              <Slider label="Saturation" value={saturation} min={0} max={3} step={0.1} onChange={v => handleEffectChange('saturation', v)} />
              <Slider label="Gamma" value={gamma} min={0.1} max={3} step={0.1} onChange={v => handleEffectChange('gamma', v)} />
            </div>
