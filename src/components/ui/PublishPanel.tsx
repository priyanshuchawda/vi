...
const PublishPanel = () => {
  ...
  // When AI-generated metadata arrives, pre-fill the form
  useEffect(() => {
    if (!pendingMeta) return;
    setTitle(pendingMeta.title);
    setDescription(pendingMeta.description);
    setTags(pendingMeta.tags);
    setPrivacyStatus(pendingMeta.privacyStatus);
    setAiFilled(true);
    clearPendingMeta();
  }, [pendingMeta, clearPendingMeta]);
