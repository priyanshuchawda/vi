...
const Toast = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className={clsx("p-2 rounded-lg transition-all duration-200", styles.iconBg)} aria-hidden="true">
          <div className={styles.iconColor}>
            {styles.icon}
          </div>
        </div>
        <div className="flex-1">
          <p className="font-semibold text-sm text-text-primary leading-tight">{notification.message}</p>
        </div>
        <button 
